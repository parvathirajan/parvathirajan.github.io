...
export const resumeData = {
  ...
  experience: [
    ...
    {
      company: systechSolutions,
      title: "Software Engineer",
      description:
        "Worked for various US clients. (Media, Retail and Insurance Domain). ",
      responsibilities: [
        "Discussed with onsite Leads/Clients for getting requirements and Involved in all part of Development Lifecycle",
        "Preparing documentation - Technical Specification, Design and QA",
        "Managing the on-time project deliverable",
        "Develop project concepts and maintain optimal workflow. Maintained the CI/CD pipeline for the project",
        "Automate the process with Python Frameworks and Process pipeline to reduce the time and effort",
      ],
      years: "09/2017 - 02/2021",
      mainTech: ["Python", "AWS", "SQL"],
      technologies: [
        "Python",
        "AWS S3",
        "Redshift",
